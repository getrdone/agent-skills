...
Before generating any section image, load [`skills/dynamic-symmetry/SKILL.md`](../dynamic-symmetry/SKILL.md).
Stamp each frame: crop, rectangle, armature, focal. Write **Dynamic Symmetry** in full in prompts (never “DS”).
Prefer matching black-line PNG grids when the pack is available. Crop integrity is mandatory.
