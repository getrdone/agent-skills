...
Before generating any brand-kit board, load [`skills/dynamic-symmetry/SKILL.md`](../dynamic-symmetry/SKILL.md).
Stamp the outer board crop + rectangle + armature; place logo/hero panels on eyes/diagonals. Write **Dynamic Symmetry** in full (never “DS”).
