...
Before generating any screen image, load [`skills/dynamic-symmetry/SKILL.md`](../dynamic-symmetry/SKILL.md).
Stamp each frame: crop, rectangle, armature, focal. Write **Dynamic Symmetry** in full in prompts (never “DS”).
Phone-mockup outer canvas still gets a lawful rectangle; UI content sits on related lines/eyes inside the screen.
